...
- 由於目前只支援 Chromium 系列瀏覽器，因此推薦搭配 [Brave 瀏覽器](https://brave.com/zh/download/) 使用。
...
- **Meme 幣** - 基於戲謔或是各種理由發行的代幣，這類代幣通常會極大量發行讓價值變的極低，如： SHIB、DOGE、HOUSKY .. 等。
